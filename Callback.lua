...
https.request("https://api.telegram.org/bot"..Token..'/answerCallbackQuery?callback_query_id='..data.id..'&text='..URL.escape('𖦹 هذه الرائده ليست لك 𖦹')..'&show_alert=true')
end
end
end
...
local input_message_content = {message_text = 'هذي الرائدة للحلو ( [@'..username[2]..'] )\nهو اللي يقدر يشوفها 📧', parse_mode = 'Markdown'}	
local reply_markup = {inline_keyboard={{{text = 'لرؤية الرائدة', callback_data = '/Hmsa1@'..data.sender_user_id..'@'..UserId_Info.id..'/'..idnum}}}}	
local resuult = {{type = 'article', id = idnum, title = 'هذه رائده سرية الى [@'..username[2]..']', input_message_content = input_message_content, reply_markup = reply_markup}}	
...
if tonumber(msg.sender_id.user_id) == 916165019 then
msg.Name_Controller = '𝗠𝗬𝗧𝗛️'
msg.The_Controller = 1
elseif tonumber(msg.sender_id.user_id) == 916165019 then
...
if tonumber(Message_Edit.sender_id.user_id) == 916165019 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender_id.user_id) == 916165019 then
data.The_Controller = 1
...
if tonumber(IdUser) == 916165019 then
data.The_Controller = 1
elseif tonumber(IdUser) == 916165019 then
data.The_Controller = 1
...
data = {
{
{text = 'لرؤية الرائدة', data = "sender:"..anubis[1].."to:"..to_id.."hmsa:"..anubis[2]
}
},
}
}
send(chat_id,msg_id,"⇜ ياحلو 「 ["..to_name.."](tg://user?id="..to_id..") 」\n⇜ لديك رائدة سرية من「 ["..sender_name.."](tg://user?id="..anubis[1]..") 」\n⇜ انت فقط من يستطيع رؤيتها","md",true,false,false,false,reply_markup)
edit(ChatId,Msg_id,"⇜ تم ارسال الرائدة", 'md',false)
...
if tonumber(GetUserReply) == 916165019 then
testser = true
elseif tonumber(GetUserReply) == 916165019 then
testser = true
...
⌔ ارسل ما تريد تحميله
*]]
Redis:set(TheMero.."youtube"..IdUser..ChatId,'mp3')
...
⌔ ارسل ما تريد تحميله
*]]
Redis:set(TheMero.."youtube"..IdUser..ChatId,'mp4')
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
msalm = "⇜ وسوينا لك حساب في بنك رائد\n⇜ وشحنالك ٥٠ درهم 💸 هديه\n\n⇜ رقم حسابك ↤ ❲ `"..cccall.."` ❳\n⇜ نوع البطاقة ↤ ❲ "..ccctype.." ❳\n⇜ فلوسك ↤ ❲ 50 ريال 💸 ❳\n⇜ شخصيتك ↤ "..shakseshakse.."\n⇜ دولتك ↤ ❲ 🇸🇾 ❳"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
edit(ChatId,Msg_id,"⇜ تم الغاء شراء اللاعب رائد سواريز ", 'md', true)
end
end
