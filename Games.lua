...
Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "رائد")
...
local Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "رائد")
...
if text== "رائده"  or text== "رائدة"  and Redis:get(TheMero..'replayallbot'..msg.chat_id) then
return send(msg.chat_id,msg.id,"⇜ اهلا بك عزيزي\n⇜ اكتب معرف البوت ثم الرساله ثم معرف الشخص\n⇜ مثال\n[@Tepthon_Bot] مرحبا [@PPF22]")
end
...
"لو خيروك |  بين أن تتكلم بالرائد فقط طوال الوقت أو أن تصرخ فقط طوال الوقت؟ ",
